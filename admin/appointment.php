            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select  * from  users;");
                ...
                <?php
                    ...
                    // Retrieve all patients and their appointments
                    $sql = "SELECT u.ID, u.department, u.date, u.time, u.current, p.pname FROM users u
                            INNER JOIN patient p ON u.pid = p.pid";
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo '<td>';
                                        echo '<a href="delete-appointment.php?id=' . $row["ID"] . '" class="non-style-link">';
                                        echo '<button class="btn-primary-soft btn button-icon btn-delete" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;">';
                                        echo '<font class="tn-in-text">Cancel</font>';
                                        echo '</button></a></td>';
                                        echo '</tr>';
                                    }
                                }
