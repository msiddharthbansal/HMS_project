                    ...
                    if($_POST){
                        ...
                        if(isset($_POST["filter"])){
                            if($_POST["showonly"]=='all'){
                                ...
                                $sqlmain= "SELECT DISTINCT patient.* FROM doctor JOIN specialties ON doctor.specialties = specialties.id JOIN users ON specialties.sname = users.department JOIN patient ON users.pid = patient.pid WHERE doctor.docid = $userid";
